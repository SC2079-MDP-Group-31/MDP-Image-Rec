    ...
    def recv_android(self) -> None:
        ...
        while True:
            ...
            ## Command: Start Moving ##
                ...
                elif message['value'] == "W50":
                    try:
                        self.stm_link.send("W50\n")
                        self.android_queue.put(AndroidMessage('info', 'Sent W50 to STM32'))
                    except Exception as e:
                        self.logger.error(f"Failed to send FW05")
                        self.android_queue.put(AndroidMessage('error', 'Failed to send W05'))
